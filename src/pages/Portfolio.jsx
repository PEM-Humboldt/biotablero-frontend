      ...
      <div className="colPort1">
        ...
        <div className="portText1">
          <p>
            ...
            conservación que se generan a partir de un método sistemático en el
            que se buscan soluciones costo efectivas para la conservación y
            gestión de la biodiversidad, seleccionando áreas donde se maximiza
            la conservación a un mínimo costo. En los últimos años, teniendo en
            cuenta los contextos políticos y el interés tanto de metas globales
            como acuerdos multilaterales, políticas nacionales y regionales por
            invertir mayores esfuerzos en acciones de conservación.
          </p>
          <p>
            ...
            representaciones de la biodiversidad, así como diversos
            ...
            respectivos enlaces para ampliar y consultar la información de cada
            proyecto.
          </p>
        </div>
      </div>
