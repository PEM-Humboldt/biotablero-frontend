...
import { MetricInfoResponse, MetricTypesMap, MetricsTypes } from "pages/search/types/metrics";
...
class SearchAPI {
   ...
   */
  static requestMetricsInfo(metricId: MetricsTypes): Promise<Array<MetricInfoResponse>> {
