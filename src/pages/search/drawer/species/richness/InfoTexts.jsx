...
SpeciesRecordsGapsTexts.info = `El Análisis de Vacíos en Biodiversidad Continental para Colombia (AVBCC) permite identificar las áreas del país que cuentan con datos primarios de biodiversidad disponibles en bases de datos como el
