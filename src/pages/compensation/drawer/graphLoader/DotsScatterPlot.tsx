 ...
 */
//////////////////////////////////////////////////////////////////////
export type ScatterPlotValue = string;
...
//IntrinsicAttributes & Omit<ScatterPlotSvgProps<ScatterPlotDatum>, "width" | "height">
...
let colorsObj; //: ColorObject
let id: string;
let sizes;
let dataBioma: string;
let getColor:(serieId: string ) => string;
let getSize: (serieId: string | number, val: string, biome: string) => number;
