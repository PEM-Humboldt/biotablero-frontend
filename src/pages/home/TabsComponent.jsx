        ...
        subcategories: [
            {
                title: "¿Qué es?",
                content:
                    "<p>Los portafolios son un conjunto de <b>áreas priorizadas</b> para la conservación que se generan a partir de un método sistemático en el que se buscan soluciones costo efectivas para la conservación y gestión de la biodiversidad, seleccionando áreas donde se <b>maximiza la conservación a un mínimo costo.</b><br><br> Las estrategias de conservación para las cuales se desarrollan portafolios incluyen <b>preservación, restauración y uso sostenible de la biodiversidad</b>.</p>",
            },
            {
                title: "¿Por qué?",
                content:
                    "<p>Los portafolios guían la gestión de la biodiversidad, indicando las áreas de mayor valor para la conservación con las <b>soluciones más costo efectivas sobre qué y dónde conservar.</b><br>La implementación de todo un portafolio en corto tiempo es poco probable, ya que nuevos contextos surgen y la información disponible para establecer prioridades de conservación se <b>actualiza constantemente</b>, lo que demanda un <b>proceso de generación de portafolios dinámico y cíclico en el tiempo.</b></p>",
            },
            {
                title: "¿Quién produce?",
                content:
                    "<p>Los portafolios de conservación han sido desarrollados con base en <b>objetivos planteados en acuerdos multilaterales, políticas nacionales y regionales.</b> Los investigadores del Instituto Humboldt en alianza con diversas instituciones nacionales e internacionales, han utilizado distintas representaciones de la biodiversidad, así como diversos condicionantes para su conservación con el fin de priorizar estas áreas.</p>",
            },
            {
                title: "¿Qué encuentras?",
                content:
                    "<p>En este módulo encuentras los <b>diferentes portafolios a escala nacional</b> generados desde el Instituto Humboldt. Cada portafolio se basa en distintos objetivos y características de conservación que responden a <b>contextos de análisis particulares,</b> por esto no hay un solo portafolio posible, pues la <b>selección de las áreas depende de los objetivos de conservación</b>.</p>",
            },
        ],
    },
    {
        ...
        subcategories: [
            ...
            },
            {
                title: "¿Por qué?",
                content:
                    "<p>Dado que uno de los pasos más difíciles de implementar en las estrategias de monitoreo comunitario es el <b>análisis de los datos,</b> se espera que esta herramienta ponga a disposición de las comunidades los resultados de la recolección de información que realizan ellos en campo, por medio de <b>gráficos que sintetizan</b> lo que van obteniendo con el tiempo. </p>",
            },
            {
                title: "¿Quién produce?",
                content:
                    "<p>Tres asociaciones comunitarias de agricultores, mujeres y hombres, víctimas del conflicto armado del departamento de Bolívar. <b>La Asociación de Mujeres Unidas de San Isidro (AMUSI)</b> compuesta por más de 30 familias del corregimiento San Isidro en el municipio El Carmen de Bolívar. <b>La Asociación Integral de Campesinos de Cañito (ASICAC)</b>, conformada por más de 40 familias de la vereda Cañito, en el municipio de San Juan Nepomuceno. <b>La Asociación de Productores Agropecuarios de la vereda Brasilar (ASOBRASILAR)</b>, compuesta por 25 asociados.</p>",
            },
            {
                title: "¿Qué encuentras?",
                content:
                            ...
                            <Box sx={{ display: "flex", flexDirection: "column", mt: 2 }}>
                                ...
                                >
                                    {categories[activeTab].subcategories.map((sub, index) => (
                                        <Tab key={sub.categories} label={sub.title} />
                                    ))}
                                </Tabs>
