  ...
  queEs: {
    ...
    description: (
      <p>
        ...
        <b>
          visualizar información existente para unos límites geográficos
          predeterminados
        </b>
        .
        {
        ...
        <b>ecología del paisaje, especies y ecosistemas</b>.
      </p>
    ),
  },
  porque: {
    ...
    description: (
      <p>
        ...
        <b>
          permite al usuario tener una lectura rápida de la información más
          relevante
        </b>
        para su área de interés bajo tres temáticas de biodiversidad: paisajes,
        especies y ecosistemas, simplificando la búsqueda y selección de
  ...
  quienProduce: {
    ...
    description: (
      <p>
        ...
        <b>
          información de mayor pertinencia para el entendimiento general del
