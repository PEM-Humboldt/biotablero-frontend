  ...
  queEs: {
    ...
    description: (
      <p>
        ...
        <b>
          ¿Qué compensar?, ¿Cuánto compensar?, ¿Dónde compensar? y ¿Cómo
          compensar?
        </b>
        , este puede ser usado para proyectos licenciados, en licenciamiento o
        en diagnóstico de alternativas.
      </p>
    ),
  },
  porque: {
    ...
    description: (
      <p>
        ...
        <b>
          segunda versión del manual de compensaciones por pérdida de
          biodiversidad
        </b>
        {
        ...
        <b>
          visualicen diferentes alternativas de compensación y creen portafolios
          con opciones que cumplan con la normatividad vigente
        </b>
        . A su vez, el módulo de compensaciones incorpora análisis regionales y
        nacionales, lo cual potencia la efectividad de las compensaciones a
        nivel nacional.
      </p>
    ),
  },
  quienProduce: {
    ...
    description: (
      <p>
        ...
        <b>cartografía oficial</b>
        {" que es analizada por el programa de "}
        <b>Gestión Territorial del Instituto Humboldt</b>
  ...
  queEncuentras: {
    ...
    description: (
      <p>
        ...
        <b>
          ecosistemas equivalentes afectados, el número total de hectáreas a
          compensar, propuesta de agrupaciones de compensaciones, y estrategias
          de cómo compensar
        </b>
        : restauración, recuperación, rehabilitación dentro y fuera de áreas
        SINAP, preservación y declaratoria de nuevas áreas protegidas. El
        usuario puede seleccionar entre las opciones ofrecidas hasta alcanzar
        las hectáreas totales a compensar, con lo cual construirá un portafolio
        inicial de opciones de compensación.
      </p>
    ),
  },
};
