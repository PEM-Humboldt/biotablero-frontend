...
const descriptions: BasicTitleTypes = {
  queEs: {
    title: "¿Qué son los indicadores de biodiversidad?",
    description: (
      <p>
        {"Los indicadores de biodiversidad son "}
        <b>medidas</b>
        {" que nos hablan sobre "}
        <b>aspectos particulares de la biodiversidad,</b>
        {
        ...
        <b>que se encuentren relacionados con un contexto particular</b>
        {
        ...
        <b>“historia” y un objetivo particular,</b>
        {
  ...
  porque: {
    title: "¿Por qué son importantes los indicadores?",
    description: (
      <p>
        {"Los indicadores son una herramienta que "}
        <b>provee información robusta</b>
        {
        ...
        <b>
          permiten evaluar cómo está nuestra biodiversidad y cómo se ve o verá
          afectada
        </b>
        {
        ...
        <b>
          convirtiéndose en herramientas poderosas para tomar decisiones
          ambientales informadas.
        </b>
      </p>
    ),
  },
