...
import { ResourcesList } from "./resourcesEditor/ResourcesList";
...
export function ResourcesEditor({
  ...
  return isLoading ? (
    ...
    <div>
      ...
      {totalResources.current > 0 && editResource === null ? (
        <>
          <ResourcesList {...{ resources, setEditResource, removeResource }} />
...
//   const [currentPage, setCurrentPage] = useState<number>(1);
//   const { user } = useUserCTX();
//   const { userInitiativesById, userInitiativesAs } = useUserInMonitoringCTX();
//
//   const fetchResources = useCallback(async () => {
//     setIsLoading(true);
//     setErrors([]);
...
//       />
//
//       {totalResources.current > 0 && currentEdit === null ? (
//         <>
