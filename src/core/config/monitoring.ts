...
export const TERRITORY_STORY_MAX_YOUTUBE_VIDEOS = 6;
export const TERRITORY_STORY_MAX_IMAGES = 6;
export const TERRITORY_STORY_IMAGE_DESCRIPTION_MAX_LENGTH = 150;
