...
const SheetHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-2 text-center sm:text-left p-6 pb-4 border-b shrink-0",
      className,
    )}
    {...props}
  />
...
const SheetFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 p-6 pt-4 border-t shrink-0 mt-auto",
      className,
    )}
    {...props}
  />
