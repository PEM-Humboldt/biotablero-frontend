...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex flex-wrap min-h-9 gap-y-2 items-center justify-center bg-muted hover:outline! hover:outline-primary/50! transition-color p-1 text-muted-foreground",
      className,
    )}
    {...props}
  />
