    ...
    return(
      <div>
        <div className="geocont invisible">
          <Card styles={'content cont1'}
          title={"¿Qué son las consultas geográficas?"}
          content="Cambiar este texto."/>
          <Card styles={'content cont2'}
          title="¿Por qué este modulo?"
          content="Los indicadores son una herramienta que
          <b>provee información robusta</b> sobre el estado
          actual de la biodiversidad y sus tendencias.
          Al ser información medible, cuantificable y periódica
          los indicadores <b>permiten evaluar cómo está nuestra
            biodiversidad y cómo se ve o verá afectada</b>  c <b>convirtiéndose en herramientas poderosas
            para tomar decisiones ambientales informadas."/>
