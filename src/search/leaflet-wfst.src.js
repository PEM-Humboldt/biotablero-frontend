...
//	CreateLayer(geoJson); // uamoreno Con esta función se crea una capa en el mapa existente en la página
    return layers;
  },
  ...
  loadFeatures: function (filter) {
    ...
    L.Util.request({
      ...
      success: function (responseText) {
		...
		//CreateLayer(responseText); // uamoreno: Aca se recibe en formato XML, pero se deja comentado; se toma de la funcion GEOJSON que formatea este valor
        that.fire('load', {
